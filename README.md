...
- **31 个无边界层级**（Level 0/1/2/3/4/6/7/9/10/11/13/14/15/18/19/20/22/33/34/37/52/66/69/90/96/231/3999/555/666/922/-1 等）采用 Minecraft 式 16×16 分块生成：走到哪里生成到哪里，确定性种子保证同存档重进世界一致。
- **9 个有限层级**（0.1/5/8/188/205/404/976/枢纽/!）边界一律为**墙**而非虚空。
- 拓扑按 F 版设定差异化：房间迷宫（房间+柱子）/ 城市街区 / 仓库大厅 / 旅馆走廊 / 田野 / 洞穴隧道 / 跑道 / 无尽楼梯间。
- 无限层 HUD 出口罗盘（8 向箭头+距离）与小地图出口箭头，避免迷失。
- 场景锚点（setPieces）在无限层同样确定性生成——字条、尸体、怪异房间真实可触。
