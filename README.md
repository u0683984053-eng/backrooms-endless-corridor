...
- **38 个无边界层级**（Level 0-22/33-97/169/231/3999/555/666/799/922/-1 等）采用 Minecraft 式 16×16 分块生成：走到哪里生成到哪里，确定性种子保证同存档重进世界一致。
- **10 个有限层级**（0.1/5/8/188/205/400/404/976/枢纽/!）边界一律为**墙**而非虚空。
...
- **48 个层级**（38 无限 + 10 有限）· **16 种实体**（含管道潜伏者/残缺者/蒸汽幻影）· **12 种物品**（含手枪/弹药/无人机）· **26 个成就** · **19 种天赋**（攻击/防御/空间/探测/生存五类）
